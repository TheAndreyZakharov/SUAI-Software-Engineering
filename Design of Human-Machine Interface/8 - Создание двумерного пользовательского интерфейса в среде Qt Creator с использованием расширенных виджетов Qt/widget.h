...
public:
    ...
    rented rentinfo;
public slots:
    void saveToFullRefundData();
    void saveToCurrentRefundData();
    void saveTableViewDataToFullRefundFile();
    void saveUserTableDataToFullRefundFile();
...
private slots:
    ...
    void on_pushButtonOperations_clicked();

    void on_pushButtonHome2_clicked();
    void on_pushButtonHome3_clicked();
    void on_pushButtonHome4_clicked();
...
private:
    ...
    QString showCost(car *value);//функция отображающая стоимость получая ее от класса calculationfacade
