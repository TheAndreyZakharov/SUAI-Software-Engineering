...
float mat_dif_Nurb[] = {0.9f, 0.9f, 0.9f, 1.0f};
float mat_spec_Nurb[] = {0.9f, 0.9f, 0.9f};
float mat_amb_Nurb[] = {0.9f, 0.9f, 0.9f};
...
void generate_textures() {
    ...
    unsigned char *data;
    // стены
    data = stbi_load("img/wall.png", &width, &height, &nrChannels, 0);
    ...
    // крыша
    data = stbi_load("img/roof.png", &width, &height, &nrChannels, 0);
